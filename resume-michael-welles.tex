...
\cvline{}{Years of experience leading technology teams on projects from conception to completion.   Focus on mobile, emerging technologies, and digital media. Comfortable working at both the micro level (building container/codec/format internals) and the macro level (building highly available and scalable platforms for digestion, management, transformation, distribution, and consumption of media).  }


\section{Work Experience}

\cventry{2017 - Present}{Director of Engineering (Mobile)}{MediData}{New York}{NY}{
	   Led engineering teams responsible for Patient Cloud platform enabling the gathering of clinical trial data directly from patients and clinicians on mobile devices and wearable devices by patients and clinicians on mobile devices.  Products include ePRO, the iOS and Android application used for patient reported outcomes,  Patient Cloud, an iOS tablet application for clinician reported outcomes  clinicians at study sites, AppConnect a native SDK for use by third party iOS and Android developers, Sensor Link, for the direct ingestion of data from wearable sensors, as well as the backend platform responsible the for the collection and processing of clinical data from these applications.    Launched two new major mobile product initiatives, migrated all native mobile development to Swift and Kotlin, built real time compliance dashboards for data reporting, introduced workflow and organizational improvements that led to a doubling of average team velocity. }

\cventry{2013 - 2016}{Director of Mobile}{Huge}{Brooklyn}{NY}{First as principal architect, then engineering director, focusing on mobile and emerging technologies.  In most recent role, head 20+ person cross-functional team of iOS, Android, and backend engineers - as well as QA analysts, designers, and product managers. Institute and evangelize agile best practices, continuous integration, and continuous delivery. Sponsor new technology investigations and initiatives (interior way-finding,  Leap Motion, Arduino, and embedded system prototypes), as well as internal outreach initiatives (meetups, open source efforts, etc.). Notable client work include `smart' bluetooth audio/video accessories that support live video streaming and voice commands, among other features, and a companion application for an AAA game publisher that allows players to scan their own likeness to be rendered as an in-game avatar, as well as numerous  BTB and BTC mobile commerce applications.}
...
\cvline{Systems}{ Experience with almost every flavor of Unix, deep
  knowledge of Linux/BSD/OSX/Unix internals, iOS, Android. }

%\subsection{Media}

\cvline{Media}{ QuickTime, H.264, MPEG-4,
  MPEG-2, JPEG, TIFF, AAC, MP3, WAV, AIFF  }

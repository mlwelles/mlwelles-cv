...
\cvline{}{Software engineer and technology leader with decades of experience building and leading teams under tight time and quality constraints.  I am a strong advocate for efficient processes, clear communication and best practices in software development.  My experience ranges from writing firmware for embedded devices to architecting distributed systems that process complex encoding workflows across thousands of machines.}
\section{Experience}
...
\cvline{-}{Led the rewrite of the platform to meet strict security and threading requirements, creating a platform that manages digital engineering assets, providing for workflow automation, secure collaboration,with cryptographically verified revisionsing and tracking of lineage and derivation relationships between assets without the backend having access to sensitive file contents.}
